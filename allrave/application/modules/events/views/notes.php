...
<section id="content">
  <section class="hbox stretch">
    ...
    <aside class="aside-md bg-white b-r" id="subNav">
      ...
      foreach ($events as $key => $p) { 
        ...
        <a href="<?=base_url()?>events/notebook/notes/<?=$p->project_id?>" data-toggle="tooltip" data-original-title="<?=$p->project_title?>">
      ...
      <section class="vbox">
        <header class="header bg-white b-b clearfix">
          <div class="row m-t-sm">
            ...
            <a class="btn btn-sm btn-dark" href="<?=base_url()?>events/view/details/<?=$this->uri->segment(4)?>" title="<?=lang('project_details')?>" data-original-title="<?=lang('project_details')?>" data-toggle="tooltip" data-placement="bottom">
            <i class="fa fa-info-circle"></i> <?=lang('project_details')?></a>
            <a class="btn btn-sm btn-primary" href="<?=base_url()?>events/view_projects/all" title="<?=lang('events')?>" data-original-title="<?=lang('events')?>" data-toggle="tooltip" data-placement="bottom">
            <i class="fa fa-coffee"></i> <?=lang('events')?></a>
            <a class="btn btn-sm btn-default" href="<?=base_url()?>events/view/add" title="<?=lang('new_project')?>" data-original-title="<?=lang('new_project')?>" data-toggle="tooltip" data-placement="bottom">
  ...
  <header class="panel-heading"> <i class="fa fa-pencil"></i> <?=lang('project')?> <?=lang('notes')?></header>
                         <?php echo form_open(base_url().'events/notebook/savenote'); ?>

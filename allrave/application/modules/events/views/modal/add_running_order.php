...
<div class="modal-dialog">
	<div class="modal-content">
		...
		<button type="button" class="close" data-dismiss="modal">&times;</button> <h4 class="modal-title">Add Running Order</h4>
		</div>
		
					<?php
			 $attributes = array('class' => 'bs-example form-horizontal');
          echo form_open(base_url().'events/tasks/add_running_order',$attributes); ?>
		...
		<div class="modal-body">
			<h4>Package</h4>
				...
				<div class="col-lg-8">
					<div class="m-b"> 				
				<select id="title" name="running_order_pid" class="form-control">

	  ...
	  <script type="text/javascript">
				jQuery(document).ready(function($){
					...
					$("#titlee").val(ui.item.title);
					$("#cprice").val(ui.item.customer_price);
					},
					minLength:1
					};
					$("#titlee").autocomplete(ac_config);
				});
</script>
<div class="modal-dialog">
	<div class="modal-content">
		<div class="modal-header">
		<button type="button" class="close" data-dismiss="modal">&times;</button> <h4 class="modal-title">Add Food</h4>
		</div>
		
					<?php
			 $attributes = array('class' => 'bs-example form-horizontal');
          echo form_open(base_url().'events/tasks/add',$attributes); ?>
		...
		<div class="modal-body">
			<h4>Package Menus</h4>
				...
				<div class="col-lg-8">
					<div class="m-b"> 				
				<select id="title" name="modify_pid" class="form-control">

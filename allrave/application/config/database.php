...
$db['default']['database'] = 'allrave';*/

//production version settings.
$db['default']['hostname'] = 'mysql.allravetransportation.com';
$db['default']['username'] = 'allravetrans';
$db['default']['password'] = '5tBqundq';
$db['default']['database'] = 'allravetransportation';
